...
import {EngineBuffer, BufferType} from "./EngineBuffer";
...
{
    private readonly data: GPUMeasurementData;
...
export class GPUEngine
{
    ...
    public createBuffer(name: string,
                        size: GPUSize64,
                        type: BufferType): EngineBuffer
    {
        return new EngineBuffer(this, name, size, type);
    }
